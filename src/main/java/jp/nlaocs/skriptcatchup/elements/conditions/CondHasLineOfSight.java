...
public class CondHasLineOfSight extends Condition {
    ...
    public boolean init(Expression<?>[] exprs, int matchedPattern, Kleenean isDelayed, ParseResult parseResult) {
        ...
        targets = exprs[1];
        if (targets.getReturnType().equals(Location.class)) {
            Skript.error("Location information cannot be used for Has Line of Sight.\n" +
                    "Has Line of Sight from location is not implemented in this version.");
            return false;
        }
